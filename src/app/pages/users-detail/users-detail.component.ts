...
export class UsersDetailComponent implements OnInit, OnDestroy {
  ...
  private listenToRouteChanges(): void {
    this.route.params.pipe(takeUntil(this.destroy$)).subscribe(params => {
      ...
      this.loadUserData(paramUsername);
      this.canChangePassword = paramUsername.toLowerCase() === this.username.toLowerCase();
    });
  ...
  onSubmit(): void {
    if (!this.userForm.valid || !this.isEditMode) return;
  ...
  showChangePassword(): boolean {
    ...
    return !!this.username && usernameSegment.toLowerCase() === this.username.toLowerCase();
  }
